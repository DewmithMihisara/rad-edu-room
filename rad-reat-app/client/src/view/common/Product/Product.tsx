...
export class Product extends Component<ProductProps, ProductStates> {
                ...
                <div className="flex justify-center">
                    {
                        this.state.isActive ?
                            ...
                            :
                            <button onClick={this.addToCartOnClick} className="w-full mt-1 p-[2.4px] bg-secondary text-[8px] border-gray-500 border-[0.5px]">Add to Cart </button>
                    }
                </div>
            </div>
        );
